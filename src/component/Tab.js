...
const Tab = () => {
  ...
  const { id, button, heading, link, confluenceImg, ConfluenceHeading, ConfluenceSmall, trelloImg, trelloHeading, trelloSmall, jiraImg, jiraHeading, jiraSmall, bigImg, } = data[value];
  ...
  return ( <>
      ...
      <div className="btn-contain">
        {data.map((btn,index) => {
          return <button key={btn.id} onClick={() => setValue(index)}
      ...
      <div className="mobile-container">
        <div className="select-container" onClick={() => setClick(!click)}>
          ...
          <div>
            {
              click ?  <MdKeyboardArrowUp/> : <BiChevronDown style={{fontSize: "20px"}}/> 
            }
        ...
        {click &&
          ...
          <div className="select-drop">
            {option.map((option,index) => (
              <div onClick={(e) => {
                setSelect(option.option1 || option.option2 || option.option3);
                setClick(false)
                setValue(index)
              }}>
                <p>{option.option1}</p>
      ...
      <div className={`tab-container`}>
        ...
        <div className="tab-info">
                  ...
                  <div className="tab-container-link">
                      <a href="" className='tab-link'>{link}</a> 
          ...
          <div className="vid-section">
              <p className="team">Join the teams that achieve the impossible every day </p>
